const courses = [
  ...
  },
  {
    ...
    price:3999 ,
    description:"Gain hands-on experience in user interface and user experience design using tools like Figma. Learn to conduct user research, create user flows, wireframes, and interactive prototypes, and build a professional design portfolio for real-world projects.",
    status: "register",
    learningOutcomes: [
  ...
  },
  {
    ...
    price: 3999,
    description:"Master React.js from the ground up. Learn component-based architecture, hooks, state management, routing, and API integration while building dynamic, real-world web applications using best practices and modern development tools.",
    status: "register",
    learningOutcomes: [
